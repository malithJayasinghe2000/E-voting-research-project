...
// Hardcoded JSON Data
const initialUsers = [
    { id: 1, name: "John Doe", email: "john.doe@example.com", role: "Village Officer" },
    { id: 2, name: "Jane Smith", email: "jane.smith@example.com", role: "Village Officer" },
    { id: 3, name: "Mark Taylor", email: "mark.taylor@example.com", role: "Village Officer" },
    { id: 4, name: "Lucy Brown", email: "lucy.brown@example.com", role: "Village Officer"},
    { id: 5, name: "David Wilson", email: "david.wilson@example.com", role: "Village Officer" },
    { id: 6, name: "Emily Clark", email: "emily.clark@example.com", role: "Village Officer"},
    { id: 7, name: "Daniel Lee", email: "daniel.lee@example.com", role: "Village Officer" },
]
                    ...
                    <div className="container mx-auto px-6 py-8">
                        <div className="bg-gray-100 flex flex-col items-center py-8">
                            ...
                            <div className="w-full max-w-6xl bg-white shadow-lg rounded-lg p-6">
                                <h1 className="text-3xl font-semibold text-gray-700 text-center mb-8">Manage Village Officers</h1>
