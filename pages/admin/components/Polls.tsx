...
const Polls: React.FC<{ polls: PollStruct[] }> = ({ polls }) => {
  return (
    <div>
      <h1 className="text-center text-[34px] font-[550px] mb-5 text-black">Elections</h1>

      <div className="grid grid-cols-1 xl:grid-cols-2 pb-7 gap-x-[200px] gap-y-20 sm:w-2/3 xl:w-5/6 ">
        {polls.map((poll, i) => (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 mx-auto w-full">
      ...
      >
        ...
        >
          ...
          <button
            onClick={() => navigate.push('/admin/elections/' + poll.id)}
