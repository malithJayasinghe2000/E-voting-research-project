...
const VoterRegistration: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (requiredFields.length > 0) {
      setMessage({
        text: `Please fill in all required fields: ${requiredFields
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Add a new voter to the electoral database with photo verification
              </p>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="p-6 bg-gray-50 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600">
                  Enter all required details and capture a photo for identification
                </p>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700">
                              Voter Type<span className="text-red-500">*</span>
                            </label>
                            <select
                              name="voterType"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700">
                            Relationship to Chief Occupier
                          </label>
                          <input
                            type="text"
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700">
                              Polling District No.<span className="text-red-500">*</span>
                            </label>
                            <input
                              type="text"
