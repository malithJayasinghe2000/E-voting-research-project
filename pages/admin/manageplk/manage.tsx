...
const ManageUsers = () => {
    ...
    const [editData, setEditData] = useState({ name: "", email: "", phone: "", district: "", status: "" });

    // Fetch all PLK users
    const fetchUsers = async () => {
        try {
            setLoading(true);
            const { data } = await axios.get("/api/Users/getPlk"); // Adjust API route if needed
    ...
    const handleEdit = (id: string) => {
        ...
        if (user) {
            setEditingUser(user);
            setEditData({ name: user.name, email: user.email, phone: user.phone, district: user.district, status: user.status });
        }
    };
    ...
    const handleEditSubmit = async () => {
        try {
            ...
            const { data } = await axios.put("/api/Users/updatePlk", {
            ...
            setEditingUser(null);
            setEditData({ name: "", email: "", phone: "", district: "", status: "" });
